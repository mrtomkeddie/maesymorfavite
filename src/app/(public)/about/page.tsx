        ...
        <section className="w-full py-16 md:py-24">
            <div className="container mx-auto max-w-5xl px-8 space-y-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <Image src="https://i.imgur.com/w3YJcM3.png" alt="Children learning in a classroom" width={500} height={400} className="rounded-2xl object-cover w-full aspect-video md:aspect-[5/4] shadow-lg" />
                </div>
