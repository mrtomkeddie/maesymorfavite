        ...
        <div className="container mx-auto max-w-7xl px-8">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
             {t.strengths.cards.map((card, index) => {
                ...
                return (
                    <Card key={index} className="bg-background/70 text-center shadow-lg border-0 rounded-2xl">
        ...
        <div className="container mx-auto max-w-5xl px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {t.keyInfo.buttons.map((button) => {
                    ...
                    return (
                        <Button key={button.label} variant="outline" size="lg" className="h-auto py-6 text-lg" asChild>
