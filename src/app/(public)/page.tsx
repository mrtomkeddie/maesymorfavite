        ...
        <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
          <div className="space-y-6">
            <h1 className="font-headline text-5xl font-extrabold tracking-tighter text-foreground md:text-7xl">
              Welcome to Maes Y Morfa Primary School
            </h1>
            <p className="max-w-md text-lg text-foreground/80">
              A vibrant and caring community where every child is encouraged to shine. Discover how we nurture a love for learning.
            </p>
            <div className="flex gap-4">
                <Button size="lg">Learn More <ArrowRight /></Button>
            ...
            <div className="col-span-2 md:col-span-1 space-y-4">
                <Card className="bg-secondary rounded-2xl">
                    <CardHeader className="p-6">
                        ...
                        <CardDescription>Happy Pupils</CardDescription>
                    </CardHeader>
                </Card>
                ...
                <CardHeader>
                    <div className="flex items-center gap-4">
                     ...
                     <CardDescription className="mt-4">
                        To create a happy, secure, and stimulating environment where every child can achieve their full potential.
                     </CardDescription>
                </CardHeader>
              <CardContent>
            ...
            <Card className="group overflow-hidden rounded-2xl border-2 border-transparent bg-background shadow-sm transition-all hover:border-primary/50 hover:shadow-lg">
                <CardHeader>
                    <div className="flex items-center gap-4">
                        ...
                        <h3 className="font-headline text-2xl font-bold">Nurturing Environment</h3>
                    </div>
                     <CardDescription className="mt-4">
                       We celebrate diversity and foster respect, kindness, and cooperation among our pupils and staff.
                     </CardDescription>
                </CardHeader>
              <CardContent>
                <div className="aspect-video w-full overflow-hidden">
            ...
            <Card className="group overflow-hidden rounded-2xl border-2 border-transparent bg-background shadow-sm transition-all hover:border-primary/50 hover:shadow-lg">
                <CardHeader>
                    <div className="flex items-center gap-4">
                     ...
                     <CardDescription className="mt-4">
                       Our broad and balanced curriculum is designed to inspire curiosity and a lifelong passion for learning.
                     </CardDescription>
                </CardHeader>
              <CardContent>
                <div className="aspect-video w-full overflow-hidden">
        ...
        <section className="py-16 md:py-24">
            <div className="container mx-auto max-w-4xl px-4 text-center">
                ...
                <p className="mt-4 max-w-2xl mx-auto text-lg text-foreground/80">
                    Log in to our secure portal, MorfaConnect, to view your child's progress, report absences, and stay up-to-date with school news.
                </p>
