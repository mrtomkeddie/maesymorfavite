...
const content = {
    en: {
        ...
        crossPostDesc: 'Automatically create a news item for this event. The event title and description will be used as the news content.',
    ...
    cy: {
        ...
        crossPostDesc: 'Creu eitem newyddion yn awtomatig ar gyfer y digwyddiad hwn. Bydd teitl a disgrifiad y digwyddiad yn cael eu defnyddio fel cynnwys y newyddion.',
