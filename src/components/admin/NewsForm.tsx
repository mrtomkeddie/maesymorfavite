...
const content = {
    en: {
        ...
        urgentDesc: 'The title will appear as a banner on the homepage. Only one news post can be urgent at a time.',
    ...
    cy: {
        ...
        urgentDesc: 'Bydd y teitl yn ymddangos fel baner ar y dudalen gartref. Dim ond un eitem newyddion all fod yn frys ar y tro.',
