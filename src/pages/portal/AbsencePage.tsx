...
const content = {
  en: {
    ...
    form: {
      ...
      multiDayDescription: "Check this if your child will be or was absent for more than one day",
  ...
  cy: {
    ...
    form: {
      ...
      multiDayDescription: "Ticiwch hwn os bydd neu os oedd eich plentyn yn absennol am fwy nag un diwrnod",
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                    <div className="space-y-0.5">
                      <FormLabel className="text-base">{t.form.multiDayLabel}</FormLabel>
                      <FormDescription>
