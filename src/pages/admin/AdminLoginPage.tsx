    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-100 p-4">
      ...
      <Card className="w-full max-w-md shadow-2xl border-0">
        <CardHeader className="text-center pt-8 pb-6">
          ...
          <CardTitle className="font-headline text-2xl mb-2">Admin Portal Login</CardTitle>
          <CardDescription>Access your admin dashboard and manage school operations.</CardDescription>
        </CardHeader>
        <CardContent>
