...
import { Loader2, Users, FileText, User, Info, MessageSquare, Award, Calendar as CalendarIcon, AlertTriangle, BookOpen, Link as LinkIcon } from 'lucide-react';
...
const content = {
    en: {
        ...
        valuesAwardButton: 'Values Award',
        outboxButton: 'Outbox',
    ...
    cy: {
        ...
        valuesAwardButton: 'Gwobr Gwerthoedd',
        outboxButton: 'Blwch Anfon',
            ...
            try {
                ...
                if (isSupabaseConfigured) {
                    ...
                    if (session?.user?.id) {
                        ...
                        // Fallback for local/dev when Supabase keys exist but no active session
                                        ...
                                        <TableRow key={child.id}>
                                            ...
                                            <TableCell className="text-right">
                                                ...
                                                <Button variant="default" size="sm" asChild className="ml-2">
                                                    <Link to={`/teacher/notify?childId=${child.id}&childName=${encodeURIComponent(child.name)}`}>
