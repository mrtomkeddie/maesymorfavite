        ...
        <section className="w-full py-16 md:py-24">
            <div className="container mx-auto max-w-5xl px-8 space-y-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    ...
                    <img src="https://i.postimg.cc/J7JTBSnT/aboutus.png" alt="Children learning in a classroom" width={500} height={400} className="object-contain w-full aspect-video md:aspect-[5/4] drop-shadow-xl" />
                </div>
                                   ...
                                   <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 pt-4">
                                       {group.members.map(member => (
                                           <div key={member.name} className="text-center">
                                                <img src="https://placehold.co/250x250.png" data-ai-hint={member.imageHint} alt={`Portrait of ${member.name}`} width={250} height={250} className="rounded-full object-cover aspect-square shadow-lg mx-auto mb-4" />
